...
export function UserForm({ children, user, onSave, roles, sectors }: UserFormProps) {
  ...
  const onSubmit = (data: UserFormValues) => {
    ...
    toast({
      title: `Usuário ${user ? 'Atualizado' : 'Adicionado'}`,
    ...
    <Dialog open={open} onOpenChange={(isOpen) => {
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            {user ? 'Atualize os detalhes do usuário.' : 'Preencha os detalhes para o novo usuário.'}
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input type="email" placeholder="usuario@email.com" {...field} disabled={!!user} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
